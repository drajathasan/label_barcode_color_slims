 ...
 * @create date 2020-08-08 21:15:48
 * @modify date 2020-08-08 21:15:48
 * @desc "Right barcode"
 */
...
// include style
include __DIR__.'/right_barcode_style.php';
?>
<!-- Left -->
<div id="noprint" style="float: left; height: 100vh; width: 250px">
    <form method="post" action="<?=MWB;?>bibliography/lbc/wizard_designer_lbc.php">
        <input type="hidden" name="type" value="right_barcode"/>
        <section style="padding: 10px;">
            ...
            <input type="text" name="barcode-lr[right][margin]" class="w-full b-none block bg-white" value="<?=$style['barcode-lr']['right']['margin']?>" onkeyup="changeMargin('right')"/>
